...
import {
  insertBatterySchema,
  selectBatterySchema,
  insertSubBatterySchema,
  insertQuestionSchema,
} from './src/schemas/questions.zod';
...
try {
  const result = insertBatterySchema.parse(validBattery);
...
try {
  const result = insertBatterySchema.parse(batteryWithoutPrefix);
...
try {
  const result = insertBatterySchema.parse(invalidBattery);
...
try {
  const result = insertSubBatterySchema.parse(validSubBattery);
...
try {
  const result = insertQuestionSchema.parse(validQuestion);
...
try {
  const result = insertQuestionSchema.parse(minimalQuestion);
...
const result = insertBatterySchema.safeParse({ name: 'test' });
if (result.success) {
