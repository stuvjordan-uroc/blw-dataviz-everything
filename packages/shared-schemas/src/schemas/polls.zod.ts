...
import { sessions, questions, respondents, responses, sessionVisualizations } from './polls';
import { z } from 'zod';
...
/**
 * SegmentVizConfig schema
 * Validates the configuration for a single visualization
 */
export const segmentVizConfigSchema = z.object({
  ...
  syntheticSampleSize: z.number().int().positive().optional(),
...
/**
 * Visualization with ID schema
 * Extends SegmentVizConfig with a unique ID field
 */
export const visualizationSchema = segmentVizConfigSchema.extend({
  id: z.string().optional(), // Optional because it gets generated by the service if not provided
});
...
// ============================================================================
// SESSION_VISUALIZATIONS TABLE SCHEMAS
// ============================================================================

export const insertSessionVisualizationsSchema = createInsertSchema(sessionVisualizations);
export const selectSessionVisualizationsSchema = createSelectSchema(sessionVisualizations);
