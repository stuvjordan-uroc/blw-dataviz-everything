...
describe('scaleLengthToCanvasX', () => {
  ...
  it('should scale a length to canvas X coordinates', () => {
    ...
    const result = scaleLengthToCanvasX(100, vizData, canvasData);
    expect(result).toBe(40);
  });

  it('should round the result to nearest integer', () => {
    // length 125 -> 50 pixels (125 * 0.4 = 50)
    const result = scaleLengthToCanvasX(125, vizData, canvasData);
    expect(result).toBe(50);
  });

  it('should round down when fractional part is less than 0.5', () => {
    // length 123 -> 49.2 -> 49 pixels
    const result = scaleLengthToCanvasX(123, vizData, canvasData);
    expect(result).toBe(49);
  });

  it('should round up when fractional part is 0.5 or greater', () => {
    // length 127 -> 50.8 -> 51 pixels
    const result = scaleLengthToCanvasX(127, vizData, canvasData);
    expect(result).toBe(51);
  });

  it('should handle zero length', () => {
    const result = scaleLengthToCanvasX(0, vizData, canvasData);
    expect(result).toBe(0);
  });

  it('should handle full width', () => {
    // vizWidth 1000 -> pixelWidth 400
    const result = scaleLengthToCanvasX(1000, vizData, canvasData);
    expect(result).toBe(400);
  });

  it('should handle fractional lengths', () => {
    // length 50.5 -> 20.2 -> 20 pixels
    const result = scaleLengthToCanvasX(50.5, vizData, canvasData);
  ...
  it('should handle very small canvas', () => {
    ...
    const result = scaleLengthToCanvasX(100, vizData, smallCanvas);
...
describe('scaleLengthToCanvasY', () => {
  ...
  it('should scale a length to canvas Y coordinates', () => {
    ...
    // length 100 -> 40 pixels
    const result = scaleLengthToCanvasY(100, vizData, canvasData);
    expect(result).toBe(40);
  });

  it('should round the result to nearest integer', () => {
    // length 125 -> 50 pixels (125 * 0.4 = 50)
    const result = scaleLengthToCanvasY(125, vizData, canvasData);
    expect(result).toBe(50);
  });

  it('should round down when fractional part is less than 0.5', () => {
    // length 123 -> 49.2 -> 49 pixels
    const result = scaleLengthToCanvasY(123, vizData, canvasData);
    expect(result).toBe(49);
  });

  it('should round up when fractional part is 0.5 or greater', () => {
    // length 127 -> 50.8 -> 51 pixels
    const result = scaleLengthToCanvasY(127, vizData, canvasData);
    expect(result).toBe(51);
  });

  it('should handle zero length', () => {
    const result = scaleLengthToCanvasY(0, vizData, canvasData);
    expect(result).toBe(0);
  });

  it('should handle full height', () => {
    // vizHeight 800 -> pixelHeight 320
    const result = scaleLengthToCanvasY(800, vizData, canvasData);
    expect(result).toBe(320);
  });

  it('should handle fractional lengths', () => {
    // length 50.5 -> 20.2 -> 20 pixels
    const result = scaleLengthToCanvasY(50.5, vizData, canvasData);
    expect(result).toBe(20);
  });
  ...
  it('should handle very small canvas', () => {
    ...
    // length 100 -> 1 pixel (100 * 0.01 = 1)
    const result = scaleLengthToCanvasY(100, vizData, smallCanvas);
    expect(result).toBe(1);
  });
});
