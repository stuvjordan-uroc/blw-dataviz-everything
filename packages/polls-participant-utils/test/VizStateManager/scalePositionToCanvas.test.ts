...
describe('scalePositionToCanvas', () => {
  ...
  it('should scale abstract position to canvas coordinates', () => {
    ...
    const result = scalePositionToCanvas(250, 200, vizData.vizWidth, vizData.vizHeight, canvasData);
  ...
  it('should round both x and y to nearest integer', () => {
    ...
    const result = scalePositionToCanvas(127, 127, vizData.vizWidth, vizData.vizHeight, canvasData);
  ...
  it('should round down when fractional part is less than 0.5', () => {
    ...
    const result = scalePositionToCanvas(123, 123, vizData.vizWidth, vizData.vizHeight, canvasData);
  ...
  it('should round up when fractional part is 0.5 or greater', () => {
    ...
    const result = scalePositionToCanvas(128, 128, vizData.vizWidth, vizData.vizHeight, canvasData);
    expect(result).toEqual({ x: 51, y: 51 });
  });

  it('should handle origin (0, 0)', () => {
    const result = scalePositionToCanvas(0, 0, vizData.vizWidth, vizData.vizHeight, canvasData);
  ...
  it('should handle maximum coordinates', () => {
    ...
    const result = scalePositionToCanvas(1000, 800, vizData.vizWidth, vizData.vizHeight, canvasData);
  ...
  it('should handle fractional abstract positions', () => {
    ...
    const result = scalePositionToCanvas(50.5, 100.5, vizData.vizWidth, vizData.vizHeight, canvasData);
  ...
  it('should handle very small canvas', () => {
    ...
    const result = scalePositionToCanvas(100, 100, vizData.vizWidth, vizData.vizHeight, smallCanvas);
  ...
  it('should handle asymmetric scaling', () => {
    ...
    const result = scalePositionToCanvas(200, 200, vizData.vizWidth, vizData.vizHeight, asymmetricCanvas);
  ...
  it('should independently round x and y coordinates', () => {
    ...
    // abstractY 128 -> 51.2 -> 51
    const result = scalePositionToCanvas(126, 128, vizData.vizWidth, vizData.vizHeight, canvasData);
