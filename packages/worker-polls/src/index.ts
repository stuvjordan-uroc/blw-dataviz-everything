import { createRedisClient, RESPONSES_STREAM, COMPUTE_GROUP, payloadFieldKey } from '@shared-broker';
...
async function bootstrap() {
  ...
  try {
    await redis.xgroup('CREATE', RESPONSES_STREAM, COMPUTE_GROUP, '$', 'MKSTREAM');
